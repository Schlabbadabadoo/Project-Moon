...
if not isfile(Library.Folder .. "hue.jpg") then
	writefile(Library.Folder .. "hue.jpg", game:HttpGet("https://raw.githubusercontent.com/Schlabbadabadoo/Project-Moon/main/hue.png?raw=true"))
end
if not isfile(Library.Folder .. "sat.jpg") then
	writefile(Library.Folder .. "sat.jpg", game:HttpGet("https://raw.githubusercontent.com/Schlabbadabadoo/Project-Moon/main/sat.png?raw=true"))
end
if not isfile(Library.Folder .. "val.jpg") then
	writefile(Library.Folder .. "val.jpg", game:HttpGet("https://raw.githubusercontent.com/Schlabbadabadoo/Project-Moon/main/val.png?raw=true"))
end
if not isfile(Library.Folder .. "highlight.jpg") then
	writefile(Library.Folder .. "highlight.jpg", game:HttpGet("https://raw.githubusercontent.com/Schlabbadabadoo/Project-Moon/main/highlight.png?raw=true"))
end
if not isfile(Library.Folder .. "alpha.jpg") then
	writefile(Library.Folder .. "alpha.jpg", game:HttpGet("https://raw.githubusercontent.com/Schlabbadabadoo/Project-Moon/main/alpha.png?raw=true"))
end
writefile(Library.Folder .. "ProggyClean.ttf", game:HttpGet("https://raw.githubusercontent.com/Schlabbadabadoo/Project-Moon/main/ProggyClean.ttf?raw=true"))
